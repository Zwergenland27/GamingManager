...
public class UsersController(IMediator mediator) : ApiController
{
	...
	/// </summary>
	/// <param name="username" example="Zwergenland27">username</param>
	/// <response code="200">Returns user</response>
	/// <response code="400">The request is invalid</response>
	/// <response code="401">Only authorized users have access to this resource</response>
	/// <response code="403">User not allowed to access this resource</response>
	[Authorize]
	[HttpGet("{username}")]
	...
	{
		if (username != User.Identity!.Name) return Forbid();
	...
	/// <response code="400">The request is invalid</response>
	/// <response code="401">Only authorized users have access to this resource</response>
	/// <response code="403">Only admins are permitted to use this method</response>
	...
	/// </summary>
	/// <param name="username" example="Zwergenland27">username</param>
	/// <response code="204">New password has been set</response>
	/// <response code="400">The request is invalid</response>
	/// <response code="401">Only authorized users have access to this resource</response>
	/// <response code="403">User not allowed to access this resource</response>
	...
	/// </summary>
	/// <param name="email" example="user@gmail.com">username</param>
	/// <response code="204">Email verification has been sent</response>
	/// <response code="400">The request is invalid</response>
	...
	/// <response code="400">The request is invalid</response>
	/// <response code="401">Only authorized users have access to this resource</response>
	/// <response code="403">User is not allowed</response>
	/// <response code="404">User not found</response>
	[Authorize]
	[HttpDelete("{username}")]
	[ProducesResponseType(StatusCodes.Status204NoContent)]
	...
	/// </summary>
	/// <param name="username" example="Zwergenland27">username</param>
	/// <response code="204">User has been edited</response>
	/// <response code="400">The request is invalid</response>
	/// <response code="401">Unauthorized</response>
	/// <response code="403">User is not allowed</response>
	/// <response code="404">User not found</response>
